...
from app.version import ADVERSARY_APP_VERSION
...
def prod_mode(app):
    ...
    logging.basicConfig(
        filename=current_app.config["ADVERSARY_LOG"],
...
def context_setup(app):
    ...
    def manage_context_vars():
        ...
        g.adversary_app_version = ADVERSARY_APP_VERSION
...
parser = argparse.ArgumentParser(
    description="Adversary is a web application that helps analysts with navigating the ATT&CK framework."
)
parser.add_argument(
    "--config",
    default="DefaultConfig",
    help=(
        "Configuration class to start Adversary with. "
